...
<body class="bg-white  flex items-center justify-center">
    <div class="text-center">
        <h1 class="text-[#023564] mt-10 text-4xl font-bold">Collaborate and Innovate</h1>
        <img src="images/group.svg" class="mx-auto my-6 w-90" alt="Description of the image">
        
       <div class="flex flex-col items-center justify-center">
            <img src="images/screen_two.svg" class="mx-auto my-6" />
             <h1 class="text-[#023564] mt-10 text-2xl font-bold">Research and Startup Collaboration</h1>
            <p class="mb-4 text-gray-600 ">Collaborate on research projects, share ideas, and create startups.<br>Transform your academic and entrepreneurial ambitions into reality.</p>
        </div>
    ...
    <script>
        ...
        // Set the screen number for the second screen
        updateDots(2);

        // Next button functionality
        document.getElementById('nextButton').addEventListener('click', function() {
            // Navigate to the next screen and update dots accordingly
            window.location.href = 'screen_three.php'; // Change this to your actual URL for the next screen
